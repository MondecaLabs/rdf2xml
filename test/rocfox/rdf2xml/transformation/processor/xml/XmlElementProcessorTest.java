 ...
 * @author Nicolas
 */
public class XmlElementProcessorTest
{
	...
	private void transform(String rootPrefix, String rootUri, String prefix, String uri, int index)
	{
		...
		XmlElementProcessor processor = new XmlElementProcessor(Utility.getModel(), input);
		
		TransformContext context = new TransformContext();
		
		writer.writeStartDocument("utf-8", "1.0");
		writer.writeStartElement(StringUtility.ensureNotNull(rootPrefix), "body", StringUtility.ensureNotNull(rootUri));
