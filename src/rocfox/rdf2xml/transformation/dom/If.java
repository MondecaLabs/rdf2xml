 ...
 * @author Nicolas
 */
public class If extends NodeContainer implements TransformNode
{
	public static final String ElementName = "if";
	
	public static final String AttributeNameTest = When.AttributeNameTest;
