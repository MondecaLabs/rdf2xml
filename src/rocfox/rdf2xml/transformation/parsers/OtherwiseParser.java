 ...
 * @author Nicolas
 */
public class OtherwiseParser extends Parser
{
	public OtherwiseParser(Transform transform)
	{
		if(transform == null)
		{
	...
	{
		return super.isElement(source) && Otherwise.ElementName.equals(source.getLocalName());
	}
	
	public Otherwise parse(Element source)
	{
		if(source == null)
		{
		...
		validate(source);
		Otherwise result = new Otherwise();
