 ...
 * @author Nicolas
 */
public class RtlTextParser extends Parser
{
	@Override
	public boolean isElement(Element source)
	{
		return super.isElement(source) && RtlText.ElementName.equals(source.getLocalName());
	}
	
	public RtlText parse(Element source)
	{
		if(source == null)
		{
